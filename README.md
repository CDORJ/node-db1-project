...
✔️-Find all customers with postal code 1010. Returns 3 records.
✔️- Find the phone number for the supplier with the id 11. Should be (010) 9984510.
✔️- List first 10 orders placed, sorted descending by the order date. The order with date 1997-02-12 should be at the top.
✔️- Find all customers that live in London, Madrid, or Brazil. Returns 18 records.
✔️- Add a customer record for _"The Shire"_, the contact name is _"Bilbo Baggins"_ the address is _"1 Hobbit-Hole"_ in _"Bag End"_, postal code _"111"_ and the country is _"Middle Earth"_.
